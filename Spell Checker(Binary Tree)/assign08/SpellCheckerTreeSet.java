...
public class SpellCheckerTreeSet {
	 ...
	 */
	public SpellCheckerTreeSet(List<String> words) {
		this();
	 ...
	 *                        dictionary
	 */
	public SpellCheckerTreeSet(File dictionaryFile) {
		this();
	...
	public void removeFromDictionary(String word) {
		//remove word from dictionary tree
		//if false, do nothing
	...
	public List<String> spellCheck(File documentFile) {
		...
		for(String word: wordsToCheck) {
			contains = dictionary.contains(word);
			if(contains == false) {
				misspelled.add(word);
			}
		}
